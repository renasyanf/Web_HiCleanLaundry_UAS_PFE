...
export default function Harga() {
  const [tampilkanRiwayatTransaksi, setTampilkanRiwayatTransaksi] = useState(false);
  ...
  return (
    <div>
      <section className="testimonial--section" id="testimonial">
        <div className="portfolio--container-box">
          <div className="portfolio--container">
            <h2 className="sections--heading">Testimoni</h2>
          </div>
        </div>
     ...
     <a className='btn btn-primary col-12' href='Riwayat'>Riwayat Transaksi</a> 
      </section>
    </div>
  );
}

// Tambahkan definisi untuk buttonStyle jika belum ada
const buttonStyle = {
